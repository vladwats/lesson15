...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (type != null) {
			System.out.println("--------------------------");
			System.out.println("The find type of food in the refrigerator: ");

			String message = "Food: type: " + type.getType() + ", brand: " + type.getBrand() + ", chamber: "
					+ type.getChamber() + ", number of shelf: " + type.getShelf();
		...
		System.out.println(" ");
		System.out.println("Is there such a food in the Refrigerator? " + foods.isInFridge(new Food("milk", "Lyahovichek", "cooling", 4)));
		
		
		foods.deleteType("milk");
